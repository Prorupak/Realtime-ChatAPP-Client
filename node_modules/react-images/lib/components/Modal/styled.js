...
var Blanket = exports.Blanket = function Blanket(props) {
  ...
  return (0, _glam2.default)(_primitives.Div, _extends({ css: getStyles('blanket', props), className: (0, _utils.className)('blanket', { isFullscreen: isFullscreen }) }, innerProps));
};
...
var Positioner = exports.Positioner = function Positioner(props) {
  ...
  return (0, _glam2.default)(
    _primitives.Div,
    _extends({ css: getStyles(_componentBaseClassNames2.default.Positioner, props), className: (0, _utils.className)(_componentBaseClassNames2.default.Positioner, { isFullscreen: isFullscreen }) }, innerProps),
    children
  );
};
...
var Dialog = exports.Dialog = function Dialog(props) {
  ...
  return removeFocusOn ? (0, _glam2.default)(
    _primitives.Div,
    _extends({ css: getStyles('dialog', props), className: (0, _utils.className)('dialog', { isFullscreen: isFullscreen }) }, innerProps),
    children
  ) : (0, _glam2.default)(
