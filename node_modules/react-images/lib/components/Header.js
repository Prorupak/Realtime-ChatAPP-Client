...
var HeaderFullscreen = exports.HeaderFullscreen = function HeaderFullscreen(props) {
  ...
  return (0, _glam2.default)(
    _primitives.Button,
    _extends({ css: getStyles('headerFullscreen', props), className: (0, _utils.className)(['header_button', 'header_button--fullscreen']), type: 'button' }, innerProps),
    children
  );
};
...
var HeaderClose = exports.HeaderClose = function HeaderClose(props) {
  ...
  return (0, _glam2.default)(
    _primitives.Button,
    _extends({ css: getStyles('headerClose', props), className: (0, _utils.className)(['header_button', 'header_button--close']), type: 'button' }, innerProps),
    children
  );
};
