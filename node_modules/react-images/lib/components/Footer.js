...
var FooterCaption = exports.FooterCaption = function FooterCaption(props) {
  ...
  return (0, _glam2.default)(
    _primitives.Span,
    { css: getStyles('footerCaption', props), className: (0, _utils.className)('footer__caption', state) },
...
var FooterCount = exports.FooterCount = function FooterCount(props) {
  ...
  return (0, _glam2.default)(
    _primitives.Span,
    { css: getStyles('footerCount', props), className: (0, _utils.className)('footer__count', state) },
    activeView,
    ' of ',
    totalViews
  );
