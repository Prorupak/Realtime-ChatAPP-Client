...
export declare class StableWSConnection<ChannelType extends UnknownType = UnknownType, CommandType extends string = LiteralStringForUnion, UserType extends UnknownType = UnknownType> {
    ...
    enableInsights?: boolean;
    insightMetrics: InsightMetrics;
    constructor({ apiKey, authType, clientID, eventCallback, logger, messageCallback, recoverCallback, tokenManager, user, userAgent, userID, wsBaseURL, device, enableInsights, insightMetrics, }: Constructor<ChannelType, CommandType, UserType>);
    /**
