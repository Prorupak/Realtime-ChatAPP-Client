...
/** @internal **/
declare type SpecResultsRec<SS extends any[], Acc extends any[]> = SS extends [infer Head, ...(infer Tail)] ? Head extends AnySystemSpec ? SpecResultsRec<Tail, [...Acc, SR<Head>]> : never : Acc;
/** @internal **/
export declare type SpecResults<SS extends SystemSpecs> = SpecResultsRec<SS, []>;
/**
