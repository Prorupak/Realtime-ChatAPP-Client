...
var UnMemoizedLoadMoreButton = function (props) {
    ...
    return (React.createElement("div", { className: 'str-chat__load-more-button' },
        React.createElement("button", { className: 'str-chat__load-more-button__button', "data-testid": 'load-more-button', disabled: refreshing, onClick: onClick }, refreshing ? React.createElement(LoadingIndicator, null) : children)));
};
